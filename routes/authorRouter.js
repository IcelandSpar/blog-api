...
const { validateBio } = require('../validators/authorValidators.js');
...
authorRouter.put('/update/:authorId', passport.authenticate('jwt', {session: false}), validateBio, updateAuthorBio);
